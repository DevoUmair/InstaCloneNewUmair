        ...
        <div className='app_header'>
            <div className="container">
                   <div className="row">
                     ...
                     <div className="col-md-6 main-head">
                          <div>
                                <img  src='images/logo512.png' style={{width:"120px"}} className='app_headerimage'></img>
                          </div>
                          <label>
                               <SearchIcon />
                     ...
                     <div className="col-md-3 ">
                         <div className='icons'>
                            ...
                            <Link to='/Profile' ><Avatar src={localStorage.getItem("Photo")} className='Post_Avatar'/></Link> 
                         </div>
                     </div>                     
                   </div>
            </div>
